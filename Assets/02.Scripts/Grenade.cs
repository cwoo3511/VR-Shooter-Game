...
public class Grenade : MonoBehaviour
{
    ...
    public float m_Damage = 100.0f;             // 데미지의 양
    public float m_ExplosionRadius = 5.0f;      // 폭발 반경
    public float m_TimeToExplode = 5.0f;        // 폭발에 걸리는 시간
    ...
    private void Explode()
    {
        ...
        // 필터링을 추가하여 m_TargerLayer 에 해당되는 충돌체만 감지
        ...
        ParticleSystem explosionEffect = Instantiate(m_ExplosionEffectPrefab
